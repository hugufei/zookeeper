...
public class LearnerHandler extends ZooKeeperThread {
    ...
    public void run() {
        try {
            ...
            // 生成NEWLEADER的packet,发给learner代表自己需要同步的信息处理完了
            ...
            // 设置同步时间，请求阶段的读取超时时间 为 tickTime * syncLimit
            ...
            // using the data
            //
            // 发送UPTODATE代表过半的机器回复了NEWLEADER的ACK，可以开始接受请求了
